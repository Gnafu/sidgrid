...
import it.sidgrid.sextante.tools.PolygonToUnsaturatedZoneAlgorithm;
 ...
 * @author sid&grid
 * GUI
 * Create UZF model layer by gvSIG gui
 * request PolygonToUnsaturatedZoneAlgorithm SEXTANTE algorithm
 */
public class CreateUnsaturatedLayer extends javax.swing.JPanel implements IWindow{
	...
	public CreateUnsaturatedLayer(MapControl mc) {
		super();
		this.mapCtrl = mc;	    
		initGUI();
	}
	...
	public WindowInfo getWindowInfo() {
		if (viewInfo == null) {			
			...
			viewInfo.setTitle(PluginServices.getText(this, "Create_UZF_Model_layer"));
		}
		return viewInfo;
	}
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			PluginServices.getMDIManager().closeWindow(CreateUnsaturatedLayer.this);
			...
			new Thread() {
				...
				public void run() {
					...
					PolygonToUnsaturatedZoneAlgorithm alg =  new PolygonToUnsaturatedZoneAlgorithm();
...
//						int dSp = Integer.parseInt(stressperiodText.getText());
						...
						params.getParameter(PolygonToUnsaturatedZoneAlgorithm.POLYGON).setParameterValue(layerZone);
						params.getParameter(PolygonToUnsaturatedZoneAlgorithm.NSP).setParameterValue(nsp);						
						
						OutputObjectsSet outputs = alg.getOutputObjects();
						Output out = outputs.getOutput(PolygonToUnsaturatedZoneAlgorithm.RESULT);	
						...
						String layerName = layerName_tmp+"_unsatur";
