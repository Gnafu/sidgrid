...
import it.sidgrid.sextante.tools.PolygonToVsfLayerAlgorithm;
 ...
 * @author sid&grid
 * GUI
 * Create VSF model layer by gvSIG gui
 * request PolygonToVsfLayerAlgorithm SEXTANTE algorithm
 */

public class CreateVsfModelLayer extends javax.swing.JPanel implements IWindow{
	...
	public CreateVsfModelLayer(MapControl mc) {
		super();
		this.mapCtrl = mc;	    
		initGUI();
	}
	...
	public WindowInfo getWindowInfo() {
		if (viewInfo == null) {			
			...
			viewInfo.setTitle(PluginServices.getText(this, "Create_VSF_Model_Layer"));
		}
		return viewInfo;
	}
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			PluginServices.getMDIManager().closeWindow(CreateVsfModelLayer.this);
			...
			new Thread() {
				...
				public void run() {
					...
					PolygonToVsfLayerAlgorithm alg =  new PolygonToVsfLayerAlgorithm();
...
//						int dSp = Integer.parseInt(stressperiodText.getText());
						...
						params.getParameter(PolygonToVsfLayerAlgorithm.POLYGON).setParameterValue(layerZone);
						params.getParameter(PolygonToVsfLayerAlgorithm.NSP).setParameterValue(nsp);						
						
						OutputObjectsSet outputs = alg.getOutputObjects();
						Output out = outputs.getOutput(PolygonToVsfLayerAlgorithm.RESULT);	
