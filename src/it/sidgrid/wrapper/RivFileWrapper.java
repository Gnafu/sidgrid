...
import it.sidgrid.sextante.wrapperTools.RivFileAlgorithm;
 ...
 * RIV package
 * RivFileAlgorithm SEXTANTE algorithm
 * 
 */

public class RivFileWrapper extends javax.swing.JPanel implements IWindow{
	...
	public RivFileWrapper(MapControl mc) {
		super();
		this.mapCtrl = mc;
		initGUI();
	}
	...
	private void initGUI() {
		...
		JLabel lblRiverLayer = new JLabel(PluginServices.getText(this,"River_layer"));
		...
		btnRun.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(comboBox.getSelectedItem() == null)
					return;
				PluginServices.getMDIManager().closeWindow(RivFileWrapper.this);
				...
				new Thread() {
					...
					public void run() {
						...
						RivFileAlgorithm alg = new RivFileAlgorithm();
						...
						try {
							...
							params.getParameter(RivFileAlgorithm.LAYER).setParameterValue(layerRiver);
							params.getParameter(RivFileAlgorithm.SP).setParameterValue(Sp.getSelectedIndex());
							params.getParameter(RivFileAlgorithm.COUNT).setParameterValue(doc.getStress());
							params.getParameter(RivFileAlgorithm.IRIVCB).setParameterValue(cbc);
							params.getParameter(RivFileAlgorithm.RIV).setParameterValue(filepath+".riv");
	...
	public WindowInfo getWindowInfo() {
		if (viewInfo == null) {
			...
			viewInfo.setTitle(PluginServices.getText(this, "Riv_package"));
